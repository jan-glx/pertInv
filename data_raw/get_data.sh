...
wget https://github.com/asncd/MIMOSCA/blob/master/GBC_CBC_pairing/gbc_cbc_dicts/dc_0hr_concat_all.csv
wget https://github.com/asncd/MIMOSCA/blob/master/GBC_CBC_pairing/gbc_cbc_dicts/ph_concat_all.csv
wget https://github.com/asncd/MIMOSCA/blob/master/GBC_CBC_pairing/gbc_cbc_dicts/promoters_concat_all.csv
wget https://github.com/asncd/MIMOSCA/blob/master/GBC_CBC_pairing/gbc_cbc_dicts/pt2_concat_all.csv
